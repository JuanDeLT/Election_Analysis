...
file_to_load = os.path.join("Resources", "election_results.csv") #gonna need to fix this
# Add a variable to save the file to a path.
file_to_save = os.path.join("analysis", "election_analysis.txt") #also gonna nead to fix this
